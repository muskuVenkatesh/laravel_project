...
class StaffCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'epf_no' => 'nullable|string|max:255|present|unique:staff,epf_no',
            'uan_no' => 'nullable|string|max:255|present|unique:staff,uan_no',
            'esi_no' => 'nullable|string|max:255|present|unique:staff,esi_no',
