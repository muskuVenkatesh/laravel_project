...
class StudentProcess implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($base64File, $fileName, $branchId)
    {
    ...
    public function handle()
    {
        try {
            ...
            Excel::import(new StudentImport($this->branchId), $tempFilePath);
            unlink($tempFilePath);
